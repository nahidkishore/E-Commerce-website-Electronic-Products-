...
?>
 ...
 welcome !<b style="color: green">shopping cart-</b> Total Items:<?php total_items();?> Total Price:<?php total_price(); ?> <a href="cart.php" style="color: green">Go to cart</a>
  ...
  <div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Payment Methods
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="success.php">Pay On Bikash</a></li>
      <li><a href="success.php">Pay On Rocket</a></li>
      <li><a href="success.php">Cash On Delivery</a></li>
    </ul>
  </div>
</div>
